...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "teaching",
          description: "Experience in teaching and lab management for undergraduate level classes",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Teachings",handler: () => {
              window.location.href = "/teachings/design-and-manufacturing-lab/";
            },},{id: "teachings-mechanical-engineering-design-3",
          ...
          section: "Teachings",handler: () => {
              window.location.href = "/teachings/mechanical-design-3/";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/Ethan_Butz_CV_V4_2026.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://discord.com/users/392720202376282112", "_blank");
        },
      },{
        id: 'social-instagram',
        title: 'Instagram',
        section: 'Socials',
        handler: () => {
          window.open("https://instagram.com/dtbutz", "_blank");
        },
      },{
